      ...
      <div className={styles.svgViewport}>
        ...
        >
          <defs>
            ...
            <linearGradient id="verifiedBtnGrad" x1="0" y1="0" x2="1" y2="1">
              <stop offset="0%" stopColor="#FB923C" />
              <stop offset="35%" stopColor="#EA5807" />
              <stop offset="100%" stopColor="#C2410C" />
            </linearGradient>
            <linearGradient id="verifiedBtnBorder" x1="0" y1="0" x2="0" y2="1">
              <stop offset="0%" stopColor="#FED7AA" stopOpacity="0.9" />
              <stop offset="100%" stopColor="#EA5807" stopOpacity="0.4" />
            </linearGradient>
            ...
            <filter id="elevatedButtonShadow" x="-20%" y="-20%" width="140%" height="160%">
              <feDropShadow dx="0" dy="6" stdDeviation="10" floodColor="#EA5807" floodOpacity="0.5" />
              <feDropShadow dx="0" dy="2" stdDeviation="3" floodColor="#000000" floodOpacity="0.7" />
            </filter>
            <filter id="elevatedHandoffShadow" x="-10%" y="-20%" width="120%" height="160%">
              <feDropShadow dx="0" dy="4" stdDeviation="8" floodColor="#000000" floodOpacity="0.5" />
              <feDropShadow dx="0" dy="1" stdDeviation="3" floodColor="#EA5807" floodOpacity="0.25" />
            </filter>
          </defs>
          ...
          <g filter="url(#cardShadow)">
            <g transform="translate(40, 42)">
              ...
              <g className="card-left-item" transform="translate(20, 186)" filter="url(#elevatedHandoffShadow)">
                <rect
                  width="360"
                  height="44"
                  rx="8"
                  ...
                  strokeWidth="1.2"
                />
                <line x1="8" y1="1" x2="352" y2="1" stroke="rgba(255,255,255,0.16)" strokeWidth="1" />

                {/* Status Pill on left */}
                <rect x="12" y="11" width="94" height="22" rx="11" fill="rgba(234, 88, 7, 0.2)" stroke="#EA5807" strokeWidth="0.8" />
                ...
                {/* Narrative content */}
                <text x="116" y="22" fill="#FFFFFF" fontSize="9.5" fontWeight="600" fontFamily="sans-serif">
          ...
          <g filter="url(#cardShadow)">
            <g transform="translate(480, 42)">
              ...
              {/* ELEVATED VERIFIED BUTTON (visually elevated, prominent 3D button with glow & badge) */}
              <g className="card-right-item" transform="translate(20, 172)" filter="url(#elevatedButtonShadow)">
                <rect
                  width="360"
                  height="46"
                  rx="8"
                  fill="url(#verifiedBtnGrad)"
                  stroke="url(#verifiedBtnBorder)"
                  strokeWidth="1.2"
                />
                {/* Top Highlight Bevel */}
                <path d="M 8 2 L 352 2" stroke="rgba(255, 255, 255, 0.4)" strokeWidth="1" strokeLinecap="round" />

                {/* Checkmark circle badge */}
                <circle cx="28" cy="23" r="10" fill="rgba(255, 255, 255, 0.22)" />
                <path d="M24 23 l3 3 l6 -6" stroke="#FFFFFF" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" fill="none" />
                ...
                {/* Version badge */}
                <rect x="306" y="12" width="42" height="22" rx="4" fill="rgba(0, 0, 0, 0.25)" />
                <text x="327" y="26" fill="#FFEDD5" fontSize="8" fontWeight="700" fontFamily="monospace" textAnchor="middle">
                  PROD
                </text>
              </g>
            </g>
